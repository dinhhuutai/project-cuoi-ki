			...
			<div class="pull-right tableTools-container">
				<div class="dt-buttons btn-overlap btn-group"
					...
					<a flag="info"
						...
						href='<c:url value="/admin-slide?type=edit"/>'
	...
	<script type="text/javascript">
		...
		if(${inext} <= ${ endP }){
			...
			next.addEventListener('click', function() {
				window.location.href = "<c:url value="/admin-slide?type=list&index=${inext}" />";
			})
		}
		...
		if(${page} > 0) {
			...
			prev.addEventListener('click', function() {
				window.location.href = "<c:url value="/admin-slide?type=list&index=${page}" />";
			})
		}
		...
		function deleteSlide(data) {
	        $.ajax({
	            ...
	            success: function(result) {
	                window.location.href = "${SlideURL}?type=list&index=${ pagecurr }&message=delete_success";
	            },
	            error: function(error) {
	                window.location.href = "${SlideURL}?type=list&index=${ pagecurr }&message=error_system";
	            },
	        });
		}
