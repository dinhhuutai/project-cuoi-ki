					...
					<form>
						...
						<div class="bor8 m-b-20 how-pos4-parent">
							...
							<img class="how-pos4 pointer-none"
								src="<c:url value='/template/user/images/icons/icon-email.png' />" alt="ICON">
						</div>
				...
				<div
					...
					<div class="flex-w w-full p-b-42">
						...
						<div class="size-212 p-t-2">
							...
							<p class="stext-115 cl6 size-213 p-t-18">${ contact.address }</p>
						</div>
					</div>
					...
					<div class="flex-w w-full p-b-42">
						...
						<div class="size-212 p-t-2">
							...
							<p class="stext-115 cl1 size-213 p-t-18">+84 ${ contact.phone }</p>
						</div>
					</div>
					...
					<div class="flex-w w-full">
						...
						<div class="size-212 p-t-2">
							...
							<p class="stext-115 cl1 size-213 p-t-18">${ contact.email }</p>
						</div>
					</div>
				</div>
			</div>
